...
`.trim()
      ...
      let msg = `🛸 Auto release process begins! Changelogs and release notes are generated by @daebot automatically. Ref: issue [#${metadata.issue.number}: ${metadata.issue.title}](${metadata.issue.html_url})`;
